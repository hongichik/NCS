...
parser.add_argument('--log_dir', default='', help='directory to save training logs; empty disables file logging')
parser.add_argument('--log_file', default='', help='log filename; default auto-generated by dataset and time')
...
def configure_logging():
    ...
    if opt.log_file:
        ...
        log_name = f'{opt.dataset}_{stamp}.log'
