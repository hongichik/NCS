...
def main() -> None:
    ...
    monitor_metric_name = args.monitor_metric
    ...
    for epoch in range(args.epochs):
        ...
        current_monitor_metric = train_mrr if monitor_metric_name == "mrr" else train_recall
        ...
        if eval_loader is not None and eval_split is not None:
            ...
            if monitor_split == eval_split:
                current_monitor_metric = eval_mrr if monitor_metric_name == "mrr" else eval_recall
