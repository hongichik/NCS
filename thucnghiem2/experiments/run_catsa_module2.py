...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lambda-cl", type=float, default=0.1, help="Contrastive Loss weight")
    parser.add_argument("--tau", type=float, default=1.0, help="Temperature for InfoNCE")
    parser.add_argument(
        "--augmentation-path",
        type=Path,
        default=None,
        help="Path to augmentation dictionaries JSON (for module 2).",
    )
...
def build_prefix_dataset(
    ...
    *,
    ...
    logger: logging.Logger,
    split_name: str,
    dict_same_leaf: dict[int, list[int]] | None = None,
    dict_sibling: dict[int, list[int]] | None = None,
) -> CategorySessionGraphDataset:
